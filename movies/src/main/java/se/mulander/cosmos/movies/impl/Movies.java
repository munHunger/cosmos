...
import se.mulander.cosmos.movies.model.TMDBCastResponse;
...
public class Movies
{
                                   ...
                                   .map(tmdb ->
                                        {
                                            ...
                                            Movie m = new Movie("https://image.tmdb.org/t/p/w185/" + tmdb.poster_path,
                                                    ...
                                                    year) : -1).addRating(
                                                    new Rating("The Movie Database", tmdb.vote_average, 10,
                                                               tmdb.vote_count));
                                            ...
                                            try
                                            {
                                                TMDBCastResponse castResponse = (TMDBCastResponse) HttpRequest
                                                        .getRequest(
    ...
    {
        return (GenreList) HttpRequest.getRequest(Settings.getSettingsValue(
                "movies.movie_db_api_uri") + "/3/genre/movie/list?api_key=" + Settings.getSettingsValue(
                "movies.movie_db_api_key"),
