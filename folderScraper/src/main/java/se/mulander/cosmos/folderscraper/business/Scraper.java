...
public class Scraper {
    ...
    public Response getFolderDBStatus() throws Exception {
        return Response.ok(Database.getObjects("from FileObject")).build();
    }
    ...
    public Response getCurrentFolderStatus() throws Exception {
        return Response.ok(new se.mulander.cosmos.folderscraper.impl.Scraper().getFolderStatus()).build();
    }
    ...
    public Response getSpecificFolderStatus(@PathParam("folder") String folder) throws Exception {
        return Response.ok(new se.mulander.cosmos.folderscraper.impl.Scraper().getFolderStatus(folder)).build();
    }
    ...
    public Response getWatcherStatus() throws Exception {
        return Response.ok(
                "{\"status\":" + (se.mulander.cosmos.folderscraper.impl.Scraper.isRunningWatcher() ? "\"running\"" :
                        "\"stopped\"") + "}")
                       .build();
    }
